...
class mission_task:
    ...
    def Run(self):
        print("current goal", self.current_goal.pose.position.x,
        ...
        if self.state == 0:
            ...
            if dyaw < 0.1 or dyaw > 6.26:
                ...
                print("last goal", self.last_goal.pose.position.x,
                      self.last_goal.pose.position.y)
                print("restore last goal", self.current_goal.pose.position.x,
                      self.current_goal.pose.position.y)
                self.goal_pub.publish(self.current_goal)
