...
class mission_task:
    def __init__(self, goal_path, parking_path, parking_id):
        ...
        self.min_distance = [0.30, 0.15, 0.1, 0.1]

        self.exceptionCheck = threading.Timer(15, self.CheckException)
    ...
    def voiceCallback(self, msg):
        ...
        if msg.angular.x != 0:
            self.glasses_num = msg.angular.y
            self.glasses_num = msg.angular.z
