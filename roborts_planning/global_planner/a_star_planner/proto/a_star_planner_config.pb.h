...
class AStarPlannerConfig : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:roborts_global_planner.AStarPlannerConfig) */ {
 public:
  ...
  inline AStarPlannerConfig* New() const { return New(NULL); }

  AStarPlannerConfig* New(::google::protobuf::Arena* arena) const;
  ...
  bool has_heuristic_function() const;
  void clear_heuristic_function();
  static const int kHeuristicFunctionFieldNumber = 4;
  const ::std::string& heuristic_function() const;
  void set_heuristic_function(const ::std::string& value);
  void set_heuristic_function(const char* value);
  void set_heuristic_function(const char* value, size_t size);
  ::std::string* mutable_heuristic_function();
  ::std::string* release_heuristic_function();
  void set_allocated_heuristic_function(::std::string* heuristic_function);
 ...
 private:
  ...
  inline void set_has_heuristic_function();
  inline void clear_has_heuristic_function();
  ...
  static ::std::string* _default_heuristic_function_;
  ::google::protobuf::internal::ArenaStringPtr heuristic_function_;
...
// optional string heuristic_function = 4 [default = "Manhattan"];
inline bool AStarPlannerConfig::has_heuristic_function() const {
  return (_has_bits_[0] & 0x00000008u) != 0;
}
inline void AStarPlannerConfig::set_has_heuristic_function() {
  _has_bits_[0] |= 0x00000008u;
}
inline void AStarPlannerConfig::clear_has_heuristic_function() {
  _has_bits_[0] &= ~0x00000008u;
}
inline void AStarPlannerConfig::clear_heuristic_function() {
  heuristic_function_.ClearToDefaultNoArena(_default_heuristic_function_);
  clear_has_heuristic_function();
}
inline const ::std::string& AStarPlannerConfig::heuristic_function() const {
...
inline void AStarPlannerConfig::set_heuristic_function(const ::std::string& value) {
...
inline void AStarPlannerConfig::set_heuristic_function(const char* value) {
  set_has_heuristic_function();
...
inline void AStarPlannerConfig::set_heuristic_function(const char* value, size_t size) {
  set_has_heuristic_function();
...
inline ::std::string* AStarPlannerConfig::mutable_heuristic_function() {
  set_has_heuristic_function();
...
inline ::std::string* AStarPlannerConfig::release_heuristic_function() {
...
inline void AStarPlannerConfig::set_allocated_heuristic_function(::std::string* heuristic_function) {
